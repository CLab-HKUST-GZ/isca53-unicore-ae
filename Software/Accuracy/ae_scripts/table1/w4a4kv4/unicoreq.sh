...
# Simple evaluation script for DSE-based mixed_unicore_auto_b{N} on WikiText.
...
for cfg in "${configs[@]}"; do
  ...
  for model in "${models[@]}"; do
    echo "Running DSE evaluation on WikiText with settings:"
    ...
    python llm_eval_wikitext.py \
      ...
      --a_fpq \
      --q_bits 4 --q_groupsize 32 --q_fpq \
      --k_bits 4 --k_groupsize 32 --k_fpq --k_adaptive \
      --v_bits 4 --v_groupsize 32 --v_fpq --v_adaptive \
      --attnw_bits 4 --attnw_groupsize 32 --attnw_fpq \
