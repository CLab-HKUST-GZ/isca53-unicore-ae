...
case class Dual_Accumulator(Width: Int) extends Component {
  ...
  val Sign_L = io.SMag_Sign_4b_L_in    // Share the same signal with SMag_Sign_8b_in for Sign_L
  val Sign_R = Mux(io.PE_Mode, io.SMag_Sign_8b_in, io.SMag_Sign_4b_R_in)
